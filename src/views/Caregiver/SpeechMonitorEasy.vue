<template>
  <div class="min-h-screen bg-white p-4 flex flex-col items-center">
    ...
    <!-- Title -->
    <p class="text-gray-600 font-semibold mb-4">EASY (3–5 WORDS)</p>
...
const phrases = [
  { text: 'I am okay', status: 'completed' },
  { text: 'It is cold', status: 'completed' },
  { text: 'I feel tired', status: 'skipped' },
  { text: 'Hello, good morning', status: 'skipped' },
  { text: 'Please help me', status: 'skipped' },
  { text: 'I need water', status: 'completed' },
  { text: 'Sit down, please', status: 'skipped' },
  { text: 'I am hungry', status: 'completed' },
  { text: 'Thank you', status: 'completed' },
  { text: 'My name is John', status: 'completed' },
]
